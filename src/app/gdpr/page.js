...
export default function Gdpr() {
  ...
  return (
    <main className="robot text-black dark:text-white max-w-[1080px] min-w-[512px] px-4 py-10 mx-auto pt-4">
      ...
      <h2 className="text-2xl font-bold pb-4" id="m3">Verantwortlicher</h2>
      <p>
        Antonio Lombardi
        <br />
        Wiener Straße 77
      ...
      <h2 className="text-2xl font-bold pb-4" id="m2427">Maßgebliche Rechtsgrundlagen</h2>
      <p>
      ...
      <h2 className="text-2xl font-bold pb-4" id="mOverview">Übersicht der Verarbeitungen</h2>
      <p>
