...
export default async function FusionImpossible() {
  ...
  const gameData = {
    name: "Fusion Impossible",
    description: "A fast-paced puzzle game where you fuse elements inside a reactor. Trigger chain reactions to rack up higher scores!",
    url: "https://don-interactive.com/fusion-impossible"
  };

  return (
    <>
      <StructuredData type="game" data={gameData} />
