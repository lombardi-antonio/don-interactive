...
export default async function FusionImpossible() {
  ...
  return (
    <main>
      <div
        className={`absolute h-auto min-h-screen w-full bg-[url('../../public/grid.png')] bg-repeat`}
      >
          ...
          <div className="col-span-full col-start-1 row-span-1 row-start-1 m-4 md:row-span-1 md:row-start-1 xl:col-span-4 xl:row-start-1 xl:m-6">
            ...
            >
              ...
              <p className="text-md pb-4 pt-2 text-left">
                Fusion Impossible is a puzzle game where you must fuse elements
                to create new, bigger elements. The goal is to create as many
                elements as possible before the board fills up. The game is over
              ...
              <div className="h-full w-full rounded-3xl">
                <table className="w-full text-left text-sm text-gray-500 rtl:text-right dark:text-gray-400">
                  <thead className="bg-transparent text-xs uppercase text-gray-700 dark:bg-gray-200 dark:bg-opacity-30 dark:text-gray-200">
                    <tr>
                      <th scope="col" className="w-10 p-2 pl-4 sm:px-6 sm:py-3">
                        Place
                      </th>
                    ...
                    {highScores != null ? (
                      highScores.map((entry, index) => (
                        ...
                        >
                          ...
                          <th className="p-2 sm:px-6 sm:py-3">{entry.score}</th>
                        </tr>
                      ))
                    ) : (
                      <p>error...</p>
                  ...
                  <tfoot>
                    <tr className="font-semibold text-gray-900 dark:text-white">
                      ...
                      ></th>
                      <th scope="row" className="p-2 text-base sm:px-6 sm:py-3">
